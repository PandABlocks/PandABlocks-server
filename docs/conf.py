...
project = "PandABlocks-server"

# The full version, including alpha/beta/rc tags.
release = PandABlocks_server.__version__
...
exclude_patterns = ["_build", "presentation*", "explanations.md", "tutorials.md", "how-to.md"]
...
github_repo = "PandABlocks-server"
